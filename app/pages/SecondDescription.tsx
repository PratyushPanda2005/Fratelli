  ...
  return (
    ...
    >
      <div
        ...
        className="min-h-screen z-50 relative -top-[120px] flex flex-col justify-center items-center "
      >
        <SectionHeading
          className=""
          title="Premium Wines"
        ...
        <div className="max-w-5xl w-full flex relative">
          ...
          <div className="w-1/3 flex justify-center items-end pb-20">
            <p className="font-clashdisplay text-black font-light max-w-[95%] text-sm">
              The Cabernet Sauvignon contributes to the backbone as well as
              freshness to this exquisite blend. The Petit Verdot, Marselan, and
              Cabernet Franc grapes paint the wine deep purple and provide
              ...
              Bordeaux, with freshness, notes of spearmint and graphite against
              a backdrop of cedar, fresh tobacco.
            </p>
          </div>
        </div>
        <Image
